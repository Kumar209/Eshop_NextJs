  ...
  return (
    <div className="w-full relative">
      <textarea
        ...
        placeholder=""
        className={`peer w-full p-4 pt-6 max-h-[150px] min-h-[150px] outline-none bg-white font-[400] border-2 rounded-md transition disabled:opacity-70 disabled:cursor-not-allowed 
